...
class ColorizedLogService {
  ...
  ///   message (String): The message to be printed
  void fileOutput({
    required FileModificationType type,
  ...
  /// `herupaOutput` is a function that takes a required parameter `message` of type `String` and
  /// prints the message in cyan color
  ///
  /// Args:
  ///   message (String): The message to be printed.
  void herupaOutput({required String message, bool isBold = false}) {
